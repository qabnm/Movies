 ...
 * @des：搜索结果页
 */
class SearchResultListAdapter : BaseQuickAdapter<SearchResultBean , BaseViewHolder>(R.layout.item_search_result) {
    override fun convert(holder: BaseViewHolder, item: SearchResultBean) {
        ...
        holder.setText(R.id.tvTime , StringUtils.append(item.year," ",item.type," ",item.county," ",item.language))
