...
class MovieLibraryFragment :BaseFragment() {
    ...
    override fun initData() {
        ...
        val coverUrl = "https://pics1.baidu.com/feed/79f0f736afc37931c4ee2c435a3a6c4341a911df.jpeg?token=04ff272dd8409c490e2e79f4b68152fb"

        typeList.add(Type(listOf("最热","最近更新","好评","新剧","经典"),"year"))
        typeList.add(Type(listOf("全部","中国大陆","美国","中国香港","中国台湾","韩国","日本"),"year"))
        typeList.add(Type(listOf("不限","2021","2020","2019","2018","2017","2016","2015","2014","2013","2012","2011","2010","2009"),"year"))
        typeList.add(Type(listOf("全部","剧情","喜剧","动作","爱情","欧美","经典","伦理","科幻","动画"),"year"))
